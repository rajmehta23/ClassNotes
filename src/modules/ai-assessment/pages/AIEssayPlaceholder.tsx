...
export const AIEssayPlaceholder: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center p-6 space-y-4">
      ...
      <p className="text-sm text-primary/60 max-w-md font-sans">
        This is a placeholder for the AI Essay Evaluation page. The AI features are currently disabled via feature flags.
      </p>
...
export default AIEssayPlaceholder;
